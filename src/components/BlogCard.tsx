...
const BlogCard = ({ post }: Props) => {
  return (
    <article 
      className="group bg-gray-950/40 hover:bg-gray-950/70 border border-gray-900 hover:border-blue-500/20 rounded-2xl overflow-hidden transition-all duration-300 flex flex-col justify-between shadow-xl"
    >
