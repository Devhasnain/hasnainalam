...
const SocialIcons = () => {
  return (
    <div className="flex items-center space-x-4">
      ...
      >
        <svg xlinkTitle="GitHub Profile" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path
            fillRule="evenodd"
      ...
      >
        <svg xlinkTitle="LinkedIn Profile" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
